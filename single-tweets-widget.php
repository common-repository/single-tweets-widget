<?php
/**
 * @package single-tweets-widget
*/
/*
Plugin Name: Single Tweets Widget
Plugin URI: http://www.crayfishstudios.com/
Description: Thanks for installing Single Tweets Widget - Display single tweets on your wordpress website.
Version: 1.0
Author: Crayfish Studios
Author URI: http://www.crayfishstudios.com/
*/
class singleTweetsWidget extends WP_Widget{
    public function __construct() {
        $params = array(
            'description' => 'Thanks for installing Single Tweets Widget - Display single tweets on your wordpress website.',
            'name' => 'Single Tweets Widget'
        );
        parent::__construct('singleTweetsWidget','',$params);
    }
...
<p>
	...
	name="<?php echo $this->get_field_name('title');?>"
        value="<?php echo !empty($title) ? $title : "Single Tweets Widget"; ?>" />
</p>
<p>
...
<p><strong>Please read documentation</strong></p>
<p>
...
<?php
    ...
    public function widget($args, $instance) {
		...
		if(empty($title)) $title = "Single Tweets Widget";
        if(empty($url)) $url = "";
        ...
        $data .= $html;
            ...
            echo $data;
			echo "<div style='font-size: 9px; color: #808080; font-weight: normal; font-family: tahoma,verdana,arial,sans-serif; line-height: 1.28; text-align: right; direction: ltr;'><a href='http://www.empirepromos.com/' target='_blank' style='color: #808080;' title='click here'>Promotional Items</a></div>";
            echo $after_widget;
    }
}
//start registering the extension
add_action('widgets_init','register_sparx_singleTweetsWidget');
function register_sparx_singleTweetsWidget(){
    register_widget('singleTweetsWidget');
}